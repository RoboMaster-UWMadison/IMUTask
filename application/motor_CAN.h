...
#define LK9025_TORQUE_TO_CMD        836.82f
#define LK9025_RPM_TO_MS						0.009013f
#define LK9025_ECD_TO_M							2.0613e-6f
#define LK9025_RADIUS								0.086f
#define LK9025_CF										2*LK9025_RADIUS*3.1415926f
typedef enum
{
    CAN_TURRET_ID = 0x200,
    CAN_SHOOT_M1 = 0x201,
